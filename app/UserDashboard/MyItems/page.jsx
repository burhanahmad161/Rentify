  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="bg-indigo-600 py-20 text-center">
        <h1 className="text-5xl font-bold text-white mb-6">My Rental Items</h1>
        <p className="text-xl text-indigo-100">
          Manage your listed rental items
        </p>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Your Listings</h2>
        {rentals.length === 0 ? (
